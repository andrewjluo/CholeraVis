...
function makeMainChart (data) {
  ...
  var main_svg = d3.select('#main_sev_v').append('svg')
    .attr('width',  svgWidth)
  ...
  // Set the threshold
  main_svg.append("linearGradient")					
  ...
  addAxesAndLegend(main_svg, xAxis, yAxis, zeroAxis, margin, chartWidth, chartHeight, chartZeroHeight);
  drawPaths(main_svg, data, x, y, ymax);
}
